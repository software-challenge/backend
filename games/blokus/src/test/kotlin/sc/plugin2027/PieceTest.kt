...
import sc.plugin2027.util.align
import sc.plugin2027.util.flip
import sc.plugin2027.util.rotate
...
class PieceTest: WordSpec({
    ...
    "Sets of coordinates" When {
        ...
        val transformations =
                ((Rotation.entries zip List(Rotation.entries.size) { false }) +
                 (Rotation.entries zip List(Rotation.entries.size) { true }))
