...
data class Piece(
    ...
    @XStreamAsAttribute val position: Coordinates = Coordinates(0, 0),
) {
    ...
    constructor(
        ...
        position: Coordinates = Coordinates(0, 0),
    ...
    constructor(color: Color, kind: PieceShape, transformation: Pair<Rotation, Boolean>, position: Coordinates):
    ...
    @XStreamOmitField
    private lateinit var _shape: Collection<Coordinates>
    /** Die normalisierte Form des Steins. */
    val shape: Collection<Coordinates>
        get() {
    ...
    @XStreamOmitField
    private lateinit var _coordinates: HashSet<Coordinates>
    ...
    val coordinates: Set<Coordinates>
        get() {
            if (!::_coordinates.isInitialized)
                // Unanry plus transforms coordinates to vector.
