 ...
 * Kara Client dar. 
 * Um eine Logik mit Kara zu programmieren muss nur von
 * dieser abstrakten Klasse abgeleitet werden.
 * 
 * Wenn ein Zug ausgeführt wird, so wird die Methode macheZug() aufgerufen, 
 * in der die Taktik realisiert werden kann.
 * Der von dieser Methode zurückgegebene Zug wird dann automatisch an den 
 * Server gesendet.
 * 
...
public abstract class KaraLogicHandler implements IGameHandler{
	...
	/**
	 * Speichert den aktuellen Spielstatus und kann zur Berechnung des gewünschten Zuges verwendet werden.
	 */
