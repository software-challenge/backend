...
uses
  ...
  ULayMove in '..\lib\ULayMove.pas',
  UExchangeMove in '..\lib\UExchangeMove.pas',
  UStone in '..\lib\UStone.pas',
  UStoneToField in '..\lib\UStoneToField.pas';
