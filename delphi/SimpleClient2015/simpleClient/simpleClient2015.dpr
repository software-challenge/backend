...
procedure Starter.start;
  ...
  begin
    ...
    writeln('Software Challenge 2015');
...
procedure Starter.zeigeHilfe(fehlerNachricht : String);
  begin
    ...
    Writeln('Bitte das Programm mit folgenden Parametern (optional) aufrufen: \n'
      + 'simpleClient2015.exe [{-h,--host} hostname]\n'
      + '                  [{-p,--port} port]\n'
      + '                  [{-r,--reservation} reservierung]');
    Writeln;
    Writeln('Beispiel: \n'
      + 'simpleClient2015.exe --host 127.0.0.1 --port 10500 --reservation PAP');
    Writeln;
    Readln;
  end;
