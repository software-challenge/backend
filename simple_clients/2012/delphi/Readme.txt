...
Dies ist der Delphi SimpleClient fur das Spiel "Manhattan" 
der Software Challenge 2012.
...
Die Projektdatei src/simpleClient/simpleClient2012.dpr kann einfach in
...
TBoard (src/lib/UBoard.pas) und enthalt bereits einige grundlegende Hilfsfunktionen.
...
unterscheidet diese Methode zunächst, ob es sich um einen Selektions- oder einen
Bauzug handelt und ruft entsprechend entweder die Methode TClient.waehleSteineAus
oder TClient.baueHochhaus auf, die dann einen entsprechenden Zug zurückliefern.

Um den Einstieg zu erleichtern, wurde bereits eine rudimentäre KI implementiert.
Diese führt einfach den erstbesten gültigen Zug aus, den sie finden kann. Diese
"Strategie" dient nur der Veranschaulichung und sollte natürlich durch eine
eigene, bessere Strategie ersetzt werden.
