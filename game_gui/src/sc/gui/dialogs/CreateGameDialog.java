...
public class CreateGameDialog extends JDialog {
	...
	private void createGUI() {
		...
		chkLoadGame = new JCheckBox(lang
				.getProperty("dialog_create_load_game_check"));
		...
		btnLoadGame = new JButton(lang
				.getProperty("dialog_create_load_game_choose"));
		...
		btnLoadGame.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				case JFileChooser.APPROVE_OPTION:
					txfLoadGame.setText(gameFileChooser.getSelectedFile()
							.getAbsolutePath());
					break;
		...
		playersModel.addColumn(lang.getProperty("dialog_create_tbl_parameter"));
	...
	private void prepareSlots(final List<KIInformation> KIs,
		...
		for (int i = 0; i < prep.getSlots().size(); i++) {
			...
			case 1: // KI intern
				...
				String paramLine = (String) model.getValueAt(i, 4);
				paramLine = paramLine == null ? "" : paramLine;
				String[] lineParams = paramLine.split(" ");
				String[] params = new String[slotParams.length
						+ lineParams.length];
