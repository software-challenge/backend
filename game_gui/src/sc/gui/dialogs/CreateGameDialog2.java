...
public class CreateGameDialog2 extends JDialog {
	...
	public CreateGameDialog2(JFrame frame) {
		super();
	...
	private void createGUI(final JFrame frame) {
		...
		cancelButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// close dialog
				CreateGameDialog2.this.dispose();
			}
		});
		// ------------------------------------------
	...
	protected void createGame() {
		...
		try {
			prep = selPlugin.getPlugin().prepareGame(ip, port,3,
					replayFilename);
		} catch (IOException e) {
			JOptionPane.showMessageDialog(this, lang
