class PersonMailer < ActionMailer::Base
  ...
  def signup_notification(person, contest, plain_password, self_created = false, url = nil)
    ...
    sent_on    Time.now
    body({ :person => person, :url => (url ? url : "http://www.software-challenge.de/wettbewerb/#{contest.subdomain}/"), :plain_password => plain_password, :self_created => self_created, :contest => contest })
  end
