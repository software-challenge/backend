...
\end{description}
\begin{verbatim}
	<acceleration step="I" acc="M"/>
	<turn step="I" direction="N"/>
	<step step="I" distance="V"/>  
	<push step="I" x="X" y="Y"/>
\end{verbatim}
\end{description}
...
<room roomId="RID">
  <data class="move">
    <actions>
      <acceleration step="0" acc="1"/>
      <step step="1" distance="3"/>
      <turn step="2" direction="-1"/>
      <step step="3" distance="1"/>
    </actions>
