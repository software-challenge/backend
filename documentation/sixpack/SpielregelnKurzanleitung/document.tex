...
% \begin{SCfigure}
% 	\centering
% 	\subfloat[Anlegen von 2 Spielsteinen]
% 	{
% 		\centering
% 		\includegraphics[width=0.3\textwidth]{images/anlegen04}
% 	}
% 	\subfloat[Ungültige Position. Die Reihe hat schon ein Pik derselben
% 	Farbe.]
% 	{
% 		\centering
% 		\includegraphics[width=0.3\textwidth]{images/anlegen02}
% 	}
% \end{SCfigure}
