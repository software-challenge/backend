...
\subsection{\label{connections}Verbindungen}
Die bestehenden Verbindungen auf dem Spielfeld.
\begin{description}
\item[X1] x-Koordinate des Startfeldes
\item[Y1] y-Koordinate des Startfeldes
\item[X2] x-Koordinate des Zielfeldes
\item[Y2] y-Koordinate des Zielfeldes
\item[Owner] Spielerfarbe des Besitzers (RED/BLUE).
\end{description}
\begin{verbatim}
<connection x1="X1" y1="Y1" x2="X2" y2="Y2" owner="Owner"/>
\end{verbatim}
