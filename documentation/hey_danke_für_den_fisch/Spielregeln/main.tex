...
und Grafik) erfolgt mit freundlicher Genehmigung der 
%% noch einzufügen
."
\newpage
\tableofcontents
...
Eisschollen, wobei die erste Reihe Reihe 0 ist. Ein mögliches Spielbrett ist in
...
\section{Spielablauf}	
	...
	Es beginnt der rote Spieler. Jeder Spieler darf innerhalb einen
	Zug machen. Innerhalb der ersten  4 Runden sind nur Setzzüge möglich. Ab der 5.
	Runde sind beginnend mit dem blauen Spieler nur noch Setzzüge möglich.\\
...
bewegen. Einn Pinguin kann hierbei nicht über oder auf andere Pinguine oder
...
Die Punkte ergeben sich aus den eingesammelten Fischen
...
\section{Ende des Spiels}
	...
	Spiel und alle Felder audf denen noch ein Pinguin steht Es gewinnt der Spieler,
	der am meisten Fische hat oder falls die Anzahl gleich ist, wer mehr Eisschollen eingesammelt hat.
	Geschiet dies nicht innerhalb der \RundenAnzahl\ Runden, so endet das Spiel
	ebenfalls.
