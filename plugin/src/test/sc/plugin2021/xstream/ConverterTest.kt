    ...
    "GameState" should {
        ...
        "serialize to complete XML" {
            GameState(startPiece = PieceShape.PENTO_L, lastMove = SetMove(Piece(Color.BLUE, PieceShape.MONO)), board = customBoard,
                    ...
                    undeployedPieceShapes = Color.values().associateWithTo(EnumMap(Color::class.java)) { color ->
                        PieceShape.values().filterNot { it.size > color.ordinal }.toMutableSet()
                    }) shouldSerializeTo """
