        ...
        "serialized" should {
            val states = listOf(
                    ...
                    Color.values().associateWithTo(EnumMap(Color::class.java)) { color ->
                        ...
                        GameState(
                                startPiece = PieceShape.PENTO_L, lastMove = SetMove(Piece(Color.BLUE, PieceShape.MONO)), board = customBoard,
            ...
            forAll(ts = states) { (state, xml) ->
                state shouldSerializeTo xml
