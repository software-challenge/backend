...
public class GameState implements Cloneable {
   ...
   */
  public final sc.plugin2018.Field getTypeAt(final int index)
  {
   ...
   */
  public final int getNextFieldByType(sc.plugin2018.Field type, int index)
  {
   ...
   */
  public final int getPreviousFieldByType(sc.plugin2018.Field type, int index)
  {
  ...
  public void setLastAction(Action action) {
    if (action instanceof sc.plugin2018.Skip) {
      return;
    }
   ...
   * @return Feldtyp
   */
  public sc.plugin2018.Field fieldOfCurrentPlayer() {
  ...
  private ArrayList<Move> checkForPlayableCards(ArrayList<Action> actions) {
    ...
    if (this.getCurrentPlayer().mustPlayCard()) { // überprüfe, ob eine Karte gespielt werden muss
      ...
      if (GameRuleLogic.isValidToPlayHurryAhead(this)) {
        Card card = new Card(sc.plugin2018.CardType.HURRY_AHEAD,  actions.size());
        actions.add(card);
      ...
      if (GameRuleLogic.isValidToPlayFallBack(this)) {
        Card card = new Card(sc.plugin2018.CardType.FALL_BACK,  actions.size());
        actions.add(card);
        // Überprüfe ob wieder auf Hasenfeld gelandet:
        GameState clone = null;
        try {
