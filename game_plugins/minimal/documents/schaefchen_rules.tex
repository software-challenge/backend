...
\section{Einführung}
Bei \glqq{Schäfchen im Trockenen\grqq} spielen zwei Spieler darum, die größte Schafherde zu bilden und damit die meisten Punkte zu sammeln. Der erste Spieler spielt in \textbf{rot}, der zweite Spieler in \textbf{blau}.
...
\begin{figure}[!t]
 ...
 \sbox\SEITENLEISTE{\includegraphics[scale=0.55]{ps/seitenleiste}}%
 \begin{pspicture}[showgrid=false](0,0)(\wd\SEITENLEISTE,\ht\SEITENLEISTE)
  ...
  \rput(4,3.95){\pscircle[fillstyle=solid,fillcolor=red,linestyle=none]{0.25}\rput[B](-.01,-.1){\white f}}
