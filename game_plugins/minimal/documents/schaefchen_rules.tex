...
\begin{figure}[!t]
 \centering
 \newsavebox\SPIELPLAN
 \sbox\SPIELPLAN{\includegraphics[scale=0.45]{ps/spielplan}}%
...
\begin{figure}[!h]
 \centering
 \newsavebox\BLUMEN
 \sbox\BLUMEN{\includegraphics[scale=0.6]{ps/blumen}}%
...
\begin{figure}[!h]
 \centering
 \newsavebox\SCHAFE
 \sbox\SCHAFE{\includegraphics[scale=0.6]{ps/schafe}}%
...
\begin{figure}[!h]
 \centering
 \newsavebox\SPIELZUG
 \sbox\SPIELZUG{\includegraphics[scale=0.5]{ps/spielzug}}%
...
\begin{figure}[!t]
 ...
 \sbox\SEITENLEISTE{\includegraphics[scale=0.45]{ps/seitenleiste}}%
 \begin{pspicture}[showgrid=false](0,0)(\wd\SEITENLEISTE,\ht\SEITENLEISTE)
  \rput[lb](0,0){\usebox\SEITENLEISTE}
 
  \rput(3,9.4){\pscircle[fillstyle=solid,fillcolor=red,linestyle=none]{0.25}\rput[B](-.01,-.1){\white a}}
  \rput(9.5,9.4){\pscircle[fillstyle=solid,fillcolor=red,linestyle=none]{0.25}\rput[B](-.01,-.1){\white b}}

  \rput(-.15,8.4){\pscircle[fillstyle=solid,fillcolor=red,linestyle=none]{0.25}\rput[B](-.01,-.1){\white c}}
  \rput(6.65,8.4){\pscircle[fillstyle=solid,fillcolor=red,linestyle=none]{0.25}\rput[B](-.01,-.1){\white c}}

  \rput(3.33,5.125){\pscircle[fillstyle=solid,fillcolor=red,linestyle=none]{0.25}\rput[B](-.01,-.1){\white d}}
  \rput(10.125,6.85){\pscircle[fillstyle=solid,fillcolor=red,linestyle=none]{0.25}\rput[B](-.01,-.1){\white e}}

  \rput(3.33,2.25){\pscircle[fillstyle=solid,fillcolor=red,linestyle=none]{0.25}\rput[B](-.01,-.1){\white f}}
  \rput(10.125,5.75){\pscircle[fillstyle=solid,fillcolor=red,linestyle=none]{0.25}\rput[B](-.01,-.1){\white f}}

  \rput(3.33,1.33){\pscircle[fillstyle=solid,fillcolor=red,linestyle=none]{0.25}\rput[B](-.01,-.1){\white g}}

  \rput(6.65,5.12){\pscircle[fillstyle=solid,fillcolor=red,linestyle=none]{0.25}\rput[B](-.01,-.1){\white h}}

  \rput(9.5,3.85){\pscircle[fillstyle=solid,fillcolor=red,linestyle=none]{0.25}\rput[B](-.01,-.1){\white i}}

  \rput(9.5,.25){\pscircle[fillstyle=solid,fillcolor=red,linestyle=none]{0.25}\rput[B](-.01,-.1){\white j}}
 \end{pspicture}
...
\begin{figure}[!t]
 ...
 \sbox\EINSTELLUNGEN{\includegraphics[scale=0.55]{ps/einstellungen}}%
